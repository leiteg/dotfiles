# vim: ft=gdb et sts=4 sw=4
# ---------------------------------------------------------------------------- #
#                                     ____    _       _ __                     #
#                          ____ _____/ / /_  (_)___  (_) /_                    #
#                         / __ `/ __  / __ \/ / __ \/ / __/                    #
#                       _/ /_/ / /_/ / /_/ / / / / / / /_                      #
#                      (_)__, /\__,_/_.___/_/_/ /_/_/\__/                      #
#                       /____/                                                 #
#                                                                              #
#                    Gustavo Leite <gustavo.leite@gmail.com>                   #
#                                                                              #
# ---------------------------------------------------------------------------- #
...
# Do not confirm before adding pending breakpoints
set breakpoint pending on

# Disassembly with Intel syntax
